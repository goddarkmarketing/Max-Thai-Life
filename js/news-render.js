(function () {
  ...
  if (root) {
    ...
    root.innerHTML =
      ...
      "</time>" +
      '<span class="article-detail-stats" data-analytics-views data-content-type="news" data-content-id="' +
      id +
      '" hidden></span>' +
      "</div>" +
      "</header>" +
      '<div class="article-prose" itemprop="articleBody">' +
      (item.editor === "richtext" && typeof item.bodyHtml === "string"
        ? '<div class="lp-rich ql-content">' + item.bodyHtml + "</div>"
