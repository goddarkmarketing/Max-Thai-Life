...
try {
    $navigation = admin_nav_delete_item($navigation, $index);
    $data['navigation'] = $navigation !== [] ? $navigation : admin_default_navigation();
    admin_nav_publish_site($data);
    admin_flash('success', 'ลบเมนูและเผยแพร่ขึ้นเว็บแล้ว');
